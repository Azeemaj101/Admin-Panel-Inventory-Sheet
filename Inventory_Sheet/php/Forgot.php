...
if (isset($_POST['submit'])) {
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($n_Password == $c_Password) {
            ...
            $upd = "UPDATE `admin` SET `PASSWORD` = '$h_Password' WHERE `admin`.`SID` = 1";
...
<body>
    ...
    <div class="pin justify-content-center align-items-center ">
        <div class="card py-5 px-5 border border-primary container1 bg-dark text-light text-center">
            ...
            <h2 class="heading mx-2 px-2 pb-2">Forgot Password Admin-Panel</h2>
            <form action="/INVENTORY_SHEET/php/Forgot.php" method="POST">
                <div class="mb-1">
...
enterKeyPressed(event)" name="submit" id="A_submit" class="btn btn-success btn-block">Confirm Password</button>
                    <a href="/INVENTORY_SHEET/index.php"><button type="button" class="btn btn-primary btn-sm">GO BACK</button></a>
                </div>
            </form>
        </div>
    </div>
